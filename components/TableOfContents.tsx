...
export const TableOfContents: React.FC<TOCProps> = ({ sections, isOpen, onClose, matchedSectionIds }) => {
  return (
    <>
      {/* Overlay */}
      <div
      ...
      >
        <div className="p-4 flex justify-between items-center border-b dark:border-slate-800">
          <h3 className="font-bold text-lg text-gray-900 dark:text-white">Mục Lục</h3>
          <button onClick={onClose} className="p-2 -mr-2 rounded-full hover:bg-gray-200 dark:hover:bg-slate-800" aria-label="Close menu">
